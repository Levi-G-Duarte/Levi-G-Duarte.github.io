          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols- md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <a
                    href="https://levi-g-duarte.github.io/Mock-Calculator-Project/"
                    className="text-emerald-400 hover:text-emerald-300 transition-colors my-4"
                    target="/blank"
                  >
                    View
              ...
              >
                ...
                <p className="text-gray-400 mb-4">
                  Using Vanilla JavaScript to create game logic of pong. Using
                  canvas methods and collision logic, pong comes to life in this
                  program. Inspired by the Soccer trend, play Soccer Pong!
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  {["HTML5", "CSS3", "JavaScript"].map((tech, key) => (
                    <span
              ...
              >
                ...
                <p className="text-gray-400 mb-4">
                  Using a third-party JavaScript Framwork. I've recreated Flappy Bird.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
              ...
              >
                ...
                <p className="text-gray-400 mb-4">
                  Using the LAMP stack to create a fun list hero creator, however the project needs a live server to run. Review my repo on Github to check the cool logic behind it
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  {["Laravael", "Bootstrap", "PHP"].map((tech, key) => (
                    <span
                      key={key}
                      className="bg-orange-500/10 text-orange-500
                                  py-1 px-3 rounded-full text-sm
